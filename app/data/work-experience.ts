...
export const WORK_EXPERIENCE: WorkExperience[] = [
  {
    ...
    description: [
      'Spearheading development of innovative educational game using VR, large-screen, and mobile platforms to teach microelectronics to children',
  ...
  },
  {
    ...
    description: [
      'Enhanced production efficiency and minimized product waste through expertise in Programmable Logic Controllers (PLCs), Human-Machine Interface (HMI), and control systems',
  ...
  },
  {
    ...
    description: [
      'Developed robust full-stack web applications for efficient data analysis from truck testing',

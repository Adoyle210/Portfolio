...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      'Created an interactive shader-based visualization that generates mesmerizing animated fractal pattern using GLSL that change over time.',
  ...
  },
  {
    ...
    description:
      'This is a mini project where I practiced animating characters in Unreal to give the appearance of flying.',
  ...
  },
  {
    ...
    description:
      'This project is a portfolio website. This was my first project building a portfolio website.',
    link: 'https://www.google.com/',
    video: 'https://www.google.com/',
  ...
  },
  {
    ...
    description:
      'This project is a animating cooking in Blender. In this project I simulated water, fire, frying,and smoke/steam effects.',
  ...
  },
  {
    ...
    description:
      'This project is a modeling and rigging a bunny. This was my first project rigging in Blender.',
    link: 'https://www.google.com/',
  ...
  },
  {
    ...
    description:
      'This project is a isometric kitchen model. This was my first project modeling in Blender.',
    link: 'https://www.google.com/',
  ...
  },
  {
    name: 'Planen',
    description:
      'Planen, derived from the German verb "to plan," is here to revolutionize the way you manage your tasks! This is my first crack at building a native Android app with Kotlin, so it\'s more of a learning experience than a finished product.',
    link: 'https://github.com/shawn120/Planen-Android',
    video: 'https://www.google.com/',
    skills: ['Mobile Development'],
    language: ['Kotlin'],
    image: [
      'img/planen/Planen1.jpeg',
      'img/planen/Planen2.jpeg',
      'img/planen/Planen3.jpeg',
      'img/planen/Planen4.jpeg',
    ],
    year: 2024,
    pinned: true,
    id: 'project2-planen',
  },
  {
    name: 'Weather App',
    description:
      'This project is a weather app that allows you to search for weather information for a specific location.',
    link: 'https://www.google.com/',
    video: 'https://www.google.com/',
  ...
  },
  {
    name: 'Tarpaulin API',
    description:
      'Tarpaulin is a lightweight course management tool that\'s an "alternative" to Canvas.',
